    ...
    while True:
        ...
        for z in enemy_loc:
            for y in range(len(archer_loc)):
                if D < R:
                    if abs(z[0] - archer_loc[y][0]) + abs(z[1] - archer_loc[y][1]) <= enemy_dist[y][0] and abs(
                            z[0] - archer_loc[y][0]) + abs(z[1] - archer_loc[y][1]) <= D:
                    ...
                    if abs(z[0] - archer_loc[y][0]) + abs(z[1] - archer_loc[y][1]) <= enemy_dist[y][0] and abs(
                            z[0] - archer_loc[y][0]) + abs(z[1] - archer_loc[y][1]) <= R:
                        if abs(z[0] - archer_loc[y][0]) + abs(z[1] - archer_loc[y][1]) == enemy_dist[y][0]:
                            if enemy[y][1] > z[1]:
                                enemy[y] = [z[0], z[1]]
                            else:
